...
<head>
  ...
  <style>
    hr { border-top: 7px solid #EE2E24; }
    .product-description { max-width: 1200px }
    .item--edit { position: relative !important; }
...
<body>
    ...
    <div class="topbar">Category: <?php echo $products->categoryMenu_NEW(); ?><!--<span class="admin--cat-settings">> Edit category</span><span id="open-configurator" class="admin--configurator">> Configurator</span> --></div>
    
    <div class="main">
        <div class="list">
            <?php echo $products->loadDescription(); ?>
        </div>
