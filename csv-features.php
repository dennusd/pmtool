...
<body>
    ...
    <div class="topbar">Categorie: <?php echo $export->categoryMenu(); ?><!--<span class="admin--cat-settings">> Edit category</span><span id="open-configurator" class="admin--configurator">> Configurator</span> --></div>
    
    <?php $export->generateCSV_inDesign(5); ?>
