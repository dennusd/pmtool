...
<body>
    ...
    <div class="topbar">
        ...
        <span style="margin-right: 20px; color: white; font-weight: bold"><a style="color: white; text-decoration: none;" href="index-pdf.php">PDF's</a></span>
    ...
    <div class="main">
        <div class="list">
            <?php echo $products->parseOverview('general'); ?>
        </div>
